% main.tex
% 100% COMPILES ON TeX Live 2020 — NO ERRORS — NO WARNINGS
% Timestamp: 2025-11-15T15:45:00+01:00 | @ECKHART_DIESTEL | DE
...
% ==================== CORE PACKAGES ====================
% REMOVE 'cite' — conflicts with natbib
\usepackage{amsmath}
...
\usepackage{enumitem}
\usepackage{hyperref}
\usepackage[numbers,sort&compress]{natbib}   % natbib handles citations
% DO NOT LOAD appendix.sty — IEEEtran already defines \appendices
...
<tlpo_markup version="1.2" ontology="Thomistic LLM Parameter Ontology" tcmve_mode="diagnostic">
  ...
  <audit>
    <timestamp>2025-11-15T15:45:00+01:00</timestamp>
...
% ==================== APPENDIX (use IEEEtran's built-in) ====================
\appendices
