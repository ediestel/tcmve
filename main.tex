...
% Updated: 2025-11-15T15:39:00+01:00 | @ECKHART_DIESTEL | DE
...
\usepackage{newtxmath}          % Safe default — no varqu/varbb
\usepackage{microtype}

% ==================== CORE PACKAGES ====================
\usepackage{cite}
\usepackage{amsmath}
\usepackage{amsthm}             % Load amsthm BEFORE amssymb to avoid \openbox clash
...
<tlpo_markup version="1.2" ontology="Thomistic LLM Parameter Ontology" tcmve_mode="diagnostic">
  ...
  <audit>
    <timestamp>2025-11-15T15:39:00+01:00</timestamp>
