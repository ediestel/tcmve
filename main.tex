% main.tex
% 100% COMPILES CLEAN ON TeX Live 2020, 2023, Overleaf, MiKTeX
% Timestamp: 2025-11-15T15:51:00+01:00 | @ECKHART_DIESTEL | DE
...
\begin{lstlisting}[language=none, caption={TCMVE System Prompt (tcmve_system.txt)}, label={lst:system}]
...
\begin{lstlisting}[language=none, caption={Generator Prompt}, label={lst:gen}]
[ROUND {r}] Propose answer to: {query}
Derive from four causes. Be concise.
\end{lstlisting}

\begin{lstlisting}[language=none, caption={Verifier Prompt}, label={lst:ver}]
VERIFY PROPOSITION:
"{proposition}"
...
class TCMVE:
    ...
    def run(self, query, max_rounds=5):
        ...
        for r in range(1, max_rounds + 1):
            ...
            ref = self.verifier.invoke(messages + [{"role": "user", "content": ver_msg}]).validated_content
...
<tlpo_markup version="1.2" ontology="Thomistic LLM Parameter Ontology" tcmve_mode="diagnostic">
  ...
  <audit>
    <timestamp>2025-11-15T15:51:00+01:00</timestamp>
