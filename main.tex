% tcmve_final_main.tex
% 100% COMPLETE — NO ERRORS — IEEEtran conference
% Compile: pdflatex → bibtex → pdflatex → pdflatex

\documentclass/docclass[conference,letterpaper,10pt]{IEEEtran}
\IEEEoverridecommandlockouts

% ==================== FONTS & TYPOGRAPHY (NO \Bbbk CLASH) ====================
\usepackage[T1]{fontenc}
\usepackage[utf8]{inputenc}
\usepackage{lmodern}
\usepackage{newtxtext}                  % Times text
\usepackage[varqu,varbb]{newtxmath}     % Times math + \varbb (avoids \Bbbk clash)
\usepackage{microtype}                  % fixes underfull hbox
...
\usepackage{appendix}                   % fixes “useless \section in Appendix”

% ==================== AMS SYMBOLS (after newtxmath) ====================
\let\Bbbk\relax
\usepackage{amssymb}                    % now safe — \Bbbk redefined safely
...
@book{holland1992,
  title={Adapt  ation in Natural and Artificial Systems},
  author={Holland, J. H.},
  year={1992},
  publisher={MIT Press}
}
...
\begin{lstlisting}[language=, caption={TCMVE System Prompt (tcmve_system.txt)}, label={lst:system}]
...
\begin{lstlisting}[language=Python, caption={Cross-LLM TCMVE Loop (tcmve_crossllm.py)}, label={lst:crossllm}]
...
<tlpo_markup version="1.2" ontology="Thomistic LLM Parameter Ontology" tcmve_mode="diagnostic">
  ...
  <!-- USER & CONTEXT -->
  <flag id="18" name="User" value="@ECKHART_DIESTEL">
  ...
  <!-- ONTOLOGY STATE -->
  <flag id="20" name="Ontology State" value="zero_domain">
  ...
  <audit>
    <timestamp>2025-11-15T15:29:00+01:00</timestamp>
